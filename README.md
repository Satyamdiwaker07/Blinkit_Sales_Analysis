...
tech stack:- Power Bi dekstop -Main data visualisation platform used for report creation DAX(data anlysis expression)-used for calculated measures,dynamic visuals, and conditional logic power querry
